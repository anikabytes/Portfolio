...
const Projects = () => {
  ...
  return (
    <div className=" border-4 border-cyan-300 animate-border-pulse m-5 sm:m-20 max-w-full  p-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-4 p-5">
        {projects.map((project, index) => (
          <div key={index} className="animate-border-pulse w-full bg-opacity-35 rounded-xl shadow-md shadow-cyan-300 overflow-hidden hover:animate-pulse cursor-pointer" onClick={() => handleBoxClick(project.link)}>
